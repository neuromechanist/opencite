...
> [!NOTE]
> **AI-agent skill:** The opencite skill ships in [neuromechanist/research-skills](https://github.com/neuromechanist/research-skills) alongside other research-tooling skills (figures, grants, manuscripts, neuroinformatics). It works with Claude Code, Codex / OpenAI, and VS Code GitHub Copilot. For Claude Code, install with `/plugin marketplace add neuromechanist/research-skills` then `/plugin install opencite@research-skills`; see the research-skills README for setup with the other agents.
